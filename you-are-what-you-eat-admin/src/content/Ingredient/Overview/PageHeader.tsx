...
function PageHeader(props) {
  ...
  const handleSubmit = async () => {
    ...
    await queryIngredientApi.addIngredient({
      ...params,
      ingr_id: parseInt(ingr_id, 10)
    });
  ...
  const tabs = [
    {
      value: 1,
      label: '耗材',
      description: '查看并编辑所有耗材信息',
      addText: '新增耗材'
    },
    {
      value: 2,
      label: '耗材管理',
      description: '查看并编辑所有耗材管理记录',
      addText: '新增耗材管理记录'
    }
  ];
          ...
          <Dialog open={open} onClose={handleClose}>
            ...
            <DialogContent>
              ...
              <Select
                ...
                onChange={(e) =>
                  handleIngredientRecordFormChange('employee_id', e)
                }
              >
              ...
              >
                {ingredients.map((item) => (
                  <MenuItem key={item.ingr_id} value={item.ingr_id}>
              ...
              <TextField
                ...
                onChange={(e) =>
                  handleIngredientRecordFormChange('ingredientRecord_type', e)
                }
              />
              ...
              <TextField
                ...
                onChange={(e) =>
                  handleIngredientRecordFormChange('ingredientRecord_reason', e)
                }
              />
              <TextField
                autoFocus
                ...
                onChange={(e) =>
                  handleIngredientRecordFormChange('ingredientRecord_cost', e)
                }
              />
              <Box
                sx={{
