...
function EnergySurplusUI() {
  ...
  const data = {
    total: [10532, 19776, 45021],
    respectively: [
      {
        name: '水',
        type: 'area',
        data: [105, 487, 236, 771, 902, 123, 233, 456, 732, 521, 444, 300]
      },
      {
        name: '电',
        type: 'area',
        data: [521, 444, 300, 105, 487, 236, 771, 902, 123, 233, 456, 732]
      },
      {
        name: '燃气',
        type: 'area',
        data: [105, 487, 732, 521, 444, 300, 236, 771, 902, 123, 233, 456]
      }
    ]
  };
                ...
                >
                  <LinearProgressError
                    ...
                    value={
                      (100 *
                        arrSum(
                          data.respectively.map(
                            (d) => d.data[new Date().getMonth()]
                          ),
                          (e) => e
                        )) /
                      arrSum(data.total, (e) => e)
                    }
                  />
                </Box>
                <Box
